<template>
  ...
  <div class="grid grid-cols-3 gap-8 grid-rows-2">
    ...
    <div class="border rounded-4xl py-6 flex items-center flex-col">
      ...
      <NuxtLink to="dates/nouvelle" class="w-10/12 py-4 bg-indigo-500 font-bold text-xl rounded-2xl text-white cursor-pointer hover:bg-indigo-600 disabled:bg-gray-400 flex items-center justify-center text-center">
          Ajouter une date
