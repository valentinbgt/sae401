  ...
  <div class="grid grid-cols-3 gap-8 grid-rows-2">
    ...
    <div class="border rounded-4xl py-6 flex items-center flex-col">
      ...
      <NuxtLink to="dates/nouvelle" class="w-full flex items-center flex-col ">
        <div class=" text-white bg-indigo-500 rounded-xl py-4 w-10/12 text-center font-bold text-xl ">Ajouter une date</div>
      </NuxtLink>
        <div class="text-white bg-indigo-500 rounded-xl mt-4 py-4 w-10/12 text-center font-bold text-xl ">Historique</div>
    </div>
  </div>
</template>
